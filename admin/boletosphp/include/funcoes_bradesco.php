...
//dv da conta
$conta_dv = formata_numero($dadosboleto["conta_dv"],0,0);
...
$agencia_codigo = $agencia."".$dadosboleto["agencia_dv"]." / ". $conta_cedente; 
...
$dadosboleto["nosso_numero"] = $dadosboleto["nosso_numero"] . "-" . $dadosboleto["nosso_numero_dv"];
