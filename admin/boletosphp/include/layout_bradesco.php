...
<li>Utilize folha A4 (210 x 297 mm) ou Carta (216 x 279 mm) e margens minimas esquerda e  direita do formulário.<br>
...
<td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top width=126 height=12> 
  <span class="campo">
  <?php echo $dadosboleto["agencia_codigo"]?> - <?= $dadosboleto["conta_cedente_dv"] ?>
  </span></td>
...
<td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top align=right width=120 height=12> 
  <span class="campo">
  <?php echo $dadosboleto["numero_documento"]?>-<?php echo $dadosboleto["nosso_numero_dv"]?> 
  </span></td>
...
documento</td></tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top colspan=3 height=12> 
  <span class="campo">
  <?php echo $dadosboleto["documento"]?> 
  </span></td>
...
<td class=cp valign=top width=7 height=12><img height=12 src=imagens/1.png width=1 border=0></td><td class=cp valign=top align=right width=180 height=12> 
  <span class="campo">
  <?php echo $dadosboleto["agencia_codigo"]?> - <?php echo $dadosboleto["conta_cedente_dv"]?>
  </span></td>
...
Desconto / Abatimentos</td></tr><tr> <td class=cp valign=top width=7 height=12> <img height=12 src=imagens/1.png width=1 border=0> </td><td class=cp valign=top align=right width=180 height=12><?= $dadosboleto['desconto'] ?></td></tr><tr> 
...
<?php echo $dadosboleto["sacado"]?> - CPF <?php echo $dadosboleto["cpfcli"]?>
</span> 
</td>
