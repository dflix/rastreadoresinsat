...
$read = new \Source\Models\Read();
        ...
        $read3->ExeRead("app_carterias", "ORDER BY wallet DESC");
        $read3->getResult();
                    ...
                    <div class="text-center col-lg-6 col-md-6 col-12 bg-<?= $modelo; ?>" >
                        <div class="wrapper count-title d-flex text-center " style="text-align: center;">
                            ...
                            <div class="name"><strong class="text-uppercase text-left" style="color:#fff; font-size: 1.5em;">Balanço</strong>
                                ...
                                <div class="page-header"> Carteira // =><p style="font-size:1.5em; color:yellow;"> <?= $_SESSION["nome_carteira"] ?></p>  </div>
 ...
 <?php 
                                    ...
                                    <li class="d-flex justify-content-between"> 
                                        <div class="left-col d-flex">
                                            ...
                                            <div class="title"><strong style="font-size:1.0em; color:#000;"><?= $value["descricao"] ?></strong>
                                                <p style="font-size:1.0em; color:#000;">R$ <?= number_format($value["valor"] / 100, 2, ",", ".")  ?> </p>
