...
<meta property='og:image' content='" . CONF_URL_BASE . "/assets/image/footer.jpg'/>
...
<meta name='twitter:image' content='" . CONF_URL_BASE . "/assets/image/footer.jpg'/>
...
<meta itemprop='image' content='" . CONF_URL_BASE . "/assets/image/footer.jpg'/> ";
        } else {
...
<title>Cotação " . CONF_SITE_TITLE . "</title>
<meta name='description' content='Cotação " . CONF_SITE_DESC . "'/>
<meta name='robots' content='index, follow'/>
<link rel='canonical' href='" . CONF_URL_BASE . "'/>

<meta property='og:title' content='Cotação " . CONF_SITE_TITLE . "'/>
<meta property='og:description' content='Blog" . CONF_SITE_DESC . "'/>
<meta property='og:url' content='" . CONF_URL_BASE . "'/>
<meta property='og:image' content='" . CONF_URL_BASE . "/assets/image/footer.jpg'/>

<meta name='twitter:title' content='Cotação " . CONF_SITE_TITLE . "'/>
<meta name='twitter:description' content='Blog" . CONF_SITE_DESC . "'/>
<meta name='twitter:url' content='" . CONF_URL_BASE . "'/>
<meta name='twitter:image' content='" . CONF_URL_BASE . "/assets/image/footer.jpg'/>

<meta itemprop='name' content='Cotação " . CONF_SITE_TITLE . "'/>
<meta itemprop='description' content='Blog" . CONF_SITE_DESC . "'/>
<meta itemprop='url' content='" . CONF_URL_BASE . "'/>
<meta itemprop='image' content='" . CONF_URL_BASE . "/assets/image/footer.jpg'/> ";
                            } else {
                                ...
                                if ($tratar['1'] == "produtos" && !empty($tratar['2'])) {
                                    ...
                                    $produtos = new Read();
                                    $produtos->ExeRead("app_prod", "WHERE slug = :a", "a={$tratar['2']}");
                                    $produtos->getResult();
...
//            
                                                                        ...
                                                                        if ($tratar['1']) {
                                                                            ...
                                                                            $paginas = new Read();
                                                                            $paginas->ExeRead("app_post", "WHERE slug = :a", "a={$tratar['1']}");
                                                                            $paginas->getResult();
                                                                            
                                                                            if(!empty($paginas->getResult())){
...
<meta name='description' content='Erro 404 página não encotrada'/>
<meta name='robots' content='index, follow'/>
<link rel='canonical' href='" . CONF_URL_BASE . "/" . $paginas->getResult()[0]["slug"] . "'/>

<meta property='og:title' content='Erro 404 Pagina não encontrada'/>
<meta property='og:description' content='Erro 404 Pagina não encontrada'/>
<meta property='og:url' content='" . CONF_URL_BASE . "/" . $paginas->getResult()[0]["slug"] . "'/>
<meta property='og:image' content='" . CONF_URL_BASE . "/uploads/" . $paginas->getResult()[0]["imagem"] . "'/>

<meta name='twitter:title' content='Erro 404 Pagina não encontrada'/>
<meta name='twitter:description' content='Erro 404 Pagina não encontrada'/>
<meta name='twitter:url' content='" . CONF_URL_BASE . "/" . $paginas->getResult()[0]["slug"] . "'/>
<meta name='twitter:image' content='" . CONF_URL_BASE . "/uploads/" . $paginas->getResult()[0]["imagem"] . "'/>

<meta itemprop='name' content='Erro 404 Pagina não encontrada'/>
<meta itemprop='description' content='Erro 404 Pagina não encontrada'/>
<meta itemprop='url' content='" . CONF_URL_BASE . "/" . $paginas->getResult()[0]["slug"] . "'/>
<meta itemprop='image' content='" . CONF_URL_BASE . "/uploads/" . $paginas->getResult()[0]["imagem"] . "'/> ";
