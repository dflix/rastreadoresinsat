...
if (!empty($data)) {
   ...
   // var_dump($data);
    ...
    $verusu->ExeRead("app_prevenda", "WHERE nome = :a AND cpf_cnpj = :b", "a={$data['nome']}&b={$data['password']}");
    $verusu->getResult();
   ...
   // var_dump($verusu);
    if ($verusu->getResult()) {
        ...
        $_SESSION['nivel'] = 1;
        $_SESSION['cliente_id'] = $verusu->getResult()[0]["id"];
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 align-items-center"> 
                         <h3>Localize seu Veículo</h3>
                         <a href="http://gpsmonitor.com.br/" target="_blank"><p class="btn btn-warning"> Link Monitoramento I </p> </a>
                         <a href="http://ap3.stc.srv.br/webcliente/insat/" target="_blank"><p class="btn btn-info"> Link Monitoramento II </p> </a>
                         </br></br>
                        </div>
                        <div class="col-lg-10 col-xl-7 mx-auto">
                            ...
                            <form action="<?= CONF_URL_BASE ?>/entrar_cliente" id="cadastro" name="form" method="post">
                                ...
                                <div class="form-group mb-3">
                                    <input  type="password" name="password" placeholder="Seu CPF ou CNPJ" required="" class="form-control rounded-pill border-0 shadow-sm px-4 text-primary">
                                </div>
